        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
          <View className="w-full items-center px-6 my-6">
            ...
            <View className="items-center mb-6 w-full">
              <Text className="text-2xl text-center text-white font-extrabold tracking-tight mt-1">
                Sign In to BreatheWell
              </Text>
              ...
              {/* Subtitle with guaranteed multi-line visibility */}
              <Text 
                numberOfLines={0}
                ellipsizeMode="none"
                className="text-xs text-slate-400 text-center mt-2.5 w-full"
                style={{ flexWrap: 'wrap' }}
              >
